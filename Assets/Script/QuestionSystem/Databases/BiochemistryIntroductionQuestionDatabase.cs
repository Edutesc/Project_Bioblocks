       ...
       // Questão 11
        ...
        new Question
        {
            ...
            answers = new string[] {
                ...
                "AnswerImages/IntroductionDB/pentano",
                "AnswerImages/IntroductionDB/2-hexeno"
            },
            correctIndex = 1,
            questionNumber = 24,
        ...
        new Question
        {
            ...
            questionHint = new QuestionHint
            {
                text = "Carbono quiral: ligado a 4 grupos DIFERENTES. Gera enantiômeros (imagens especulares não sobreponíveis). 2-metil-2-amino-butano: o C2 tem -NH₂, -CH₃, -CH₃ e -CH₂CH₃ → dois grupos CH₃ iguais = NÃO é quiral. 2-amino-butano: CH₃-CH(NH₂)-CH₂-CH₃ → C2 ligado a -NH₂, -H, -CH₃ e -CH₂CH₃ = 4 grupos diferentes = QUIRAL. N-metil-propanamina e N-trimetil-etanamina: o N é que varia, não há C quiral claro nas cadeias.",
                imagePath = null,
                videoUrl = null,
                link = null
            }
        ...
        new Question
        {
            ...
            questionHint = new QuestionHint
            {
                text = "Amina terciária: N ligado a 3 grupos carbônicos, sem H no nitrogênio. 2-metil-2-amino-butano: N-H₂ ligado a carbono terciário da cadeia → amina primária (o 'terciário' refere-se ao carbono, não à amina!). 2-amino-butano: N-H₂ → amina primária. N-trimetil-etanamina: N ligado a 4 carbonos = quaternária (N⁺). N,N-dimetil-etanamina: (CH₃)₂-N-CH₂-CH₃ → 3 carbonos no N, sem H = amina terciária.",
                imagePath = null,
                videoUrl = null,
                link = null
            }
        ...
        new Question
        {
            ...
            answers = new string[] {
                ...
                "As duplas ligações criam dobras na cadeia, impedindo o empacotamento ordenado entre as moléculas",
        ...
        new Question
        {
            ...
            isImageAnswer = false,
            isImageQuestion = true,
            questionImagePath = "QuestionImages/IntroductionDB/introductionDB_ImageQuestionContainer65",
            questionLevel = 2,
            questionInDevelopment = false,
        ...
        new Question
        {
            ...
            answers = new string[] 
            {
                "Porque estereoisômeros sempre têm propriedades iguais e podem ser trocados entre si",
                "Porque a orientação espacial pode mudar propriedades e interações com sistemas quirais",
                "Porque estereoisômeros possuem números diferentes de átomos de carbono",
                "Porque a estereoisomeria ocorre apenas em moléculas com dupla ligação C=C"
            },
            correctIndex = 1,
            questionNumber = 66,
            isImageAnswer = false,
        ...
        new Question
        {
            ...
            isImageAnswer = false,
            isImageQuestion = true,
            questionImagePath = "QuestionImages/IntroductionDB/introductionDB_ImageQuestionContainer67",
            questionLevel = 2,
            questionInDevelopment = false,
        ...
        new Question
        {
            ...
            answers = new string[] 
            {
                "Porque o nitrogênio da amida é tetraédrico sp3, impedindo a rotação",
                "Porque a ressonância N-C=O dá caráter parcial de dupla à ligação C-N",
                "Porque ligações de hidrogênio intramoleculares mantêm todos os átomos fixos",
                "Porque a carbonila atrai os átomos vizinhos por força eletrostática"
            },
            correctIndex = 1,
            questionNumber = 68,
            isImageAnswer = false,
            isImageQuestion = true,
            questionImagePath = "QuestionImages/IntroductionDB/introductionDB_ImageQuestionContainer68",
            questionLevel = 2,
            questionInDevelopment = false,
        ...
        new Question
        {
            ...
            isImageAnswer = false,
            isImageQuestion = true,
            questionImagePath = "QuestionImages/IntroductionDB/introductionDB_ImageQuestionContainer69",
            questionLevel = 2,
        ...
        new Question
        {
            ...
            answers = new string[] 
            {
                "Porque ésteres geralmente têm menor massa molecular que os ácidos correspondentes",
                "Porque ésteres não doam H e são mais voláteis; ácidos carboxílicos formam dímeros por H",
                "Porque ácidos carboxílicos sempre contêm enxofre em sua estrutura",
                "Porque ésteres possuem dupla ligação C=C, responsável pelo aroma"
            },
            correctIndex = 1,
            questionNumber = 70,
            isImageAnswer = false,
        ...
        new Question
        {
            ...
            answers = new string[] {
                ...
                "Porque no fenol o -OH está ligado a um carbono sp2; no álcool, o -OH está em carbono sp3",
            ...
            isImageAnswer = false,
            isImageQuestion = true,
            questionImagePath = "QuestionImages/IntroductionDB/introductionDB_ImageQuestionContainer71",
            questionLevel = 2,
            questionInDevelopment = false,
        ...
        new Question
        {
            ...
            answers = new string[] {
                ...
                "Na amida, o nitrogênio está ligado a uma carbonila; na imina, o nitrogênio faz uma ligação dupla com o carbono",
        ...
        new Question
        {
            ...
            answers = new string[] {
                ...
                "Carbonila (C=O) e hidroxila (–OH); a combinação permite tanto doar próton quanto fazer ligações de hidrogênio",
            ...
            isImageAnswer = false,
            isImageQuestion = true,
            questionImagePath = "QuestionImages/IntroductionDB/introductionDB_ImageQuestionContainer74",
            questionLevel = 2,
            questionInDevelopment = false,
        ...
        new Question
        {
            ...
            isImageAnswer = false,
            isImageQuestion = true,
            questionImagePath = "QuestionImages/IntroductionDB/introductionDB_ImageQuestionContainer75",
            questionLevel = 3,
            questionInDevelopment = false,
        ...
        new Question
        {
            ...
            answers = new string[] 
            {
                "Verdadeira: todo composto com O e C é polar e muito solúvel em água",
                "Falsa: ésteres e éteres de cadeia longa têm O, mas a cadeia apolar reduz a solubilidade",
                "Verdadeira apenas para compostos que possuem grupo carbonila",
                "Falsa apenas quando o composto tem mais de 10 carbonos"
            },
            correctIndex = 1,
            questionNumber = 79,
            isImageAnswer = false,
        ...
        new Question
        {
            ...
            answers = new string[]
            {
                "Verdadeira: a fórmula molecular determina todas as propriedades físicas",
                "Falsa: cis/trans têm geometrias distintas, mudando dipolo, ebulição e solubilidade",
                "Verdadeira apenas para alcenos com mais de seis carbonos",
                "Falsa apenas quando os substituintes são grupos polares"
            },
            correctIndex = 1,
            questionNumber = 81,
            isImageAnswer = false,
        ...
        new Question
        {
            ...
            answers = new string[] {
                ...
                "O ácido tem maior ponto de ebulição porque forma dímeros por ligação de hidrogênio",
        ...
        new Question
        {
            ...
            answers = new string[] {
                "Verdadeira: todo carbono quiral garante atividade biológica",
                "Parcial: quiralidade pode alterar interações, mas a atividade depende do contexto",
                "Falsa: carbono quiral não influencia interações biológicas",
        ...
        new Question
        {
            ...
            answers = new string[] {
                "Verdadeira: todo nitrogênio com par livre tem a mesma basicidade",
                "Falsa: na amida, o par do N se deslocaliza com a carbonila, reduzindo a basicidade",
                "Verdadeira apenas para amidas, pois a carbonila aumenta a basicidade do N",
                "Falsa: nitrogênios orgânicos nunca atuam como bases"
            },
            correctIndex = 1,
            questionNumber = 84,
            isImageAnswer = false,
        ...
        new Question
        {
            ...
            answers = new string[] {
                "Sim: a fórmula molecular basta para classificar qualquer composto orgânico",
                "Não: mesma fórmula pode gerar grupos funcionais distintos; é preciso analisar a estrutura",
                "Sim, mas apenas para compostos com menos de quatro carbonos",
                "Não, mas apenas quando há nitrogênio ou enxofre na molécula"
            },
            correctIndex = 1,
            questionNumber = 85,
            isImageAnswer = false,
