...
//        // Question 003
        new Question
        {
            ...
            answers = new string[] {
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer003.0",
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer003.1",
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer003.2",
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer003.3"
            },
            correctIndex = 1,
            questionNumber = 3,
            ...
            prerequisites = null,
            questionHint = new QuestionHint { text = "Relacione velocidade de reação com a barreira que separa reagentes e produtos. A enzima oferece um caminho alternativo para a transformação química, tornando mais fácil atingir o estado intermediário necessário sem mudar o equilíbrio final da reação. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Compare as duas reações como obstáculos de alturas diferentes. Nas mesmas condições, moléculas atravessam com mais frequência o obstáculo que exige menor energia para iniciar a transformação. Use essa ideia para relacionar barreira energética e velocidade observada. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Observe que a pergunta trata de uma região da própria enzima, não de uma molécula externa. Lembre que a função catalítica depende de uma parte com forma e propriedades químicas adequadas para reconhecer o reagente específico. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//        // Question 008
        new Question
        {
            ...
            answers = new string[] {
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer008.0",
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer008.1",
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer008.2",
                "AnswerImages/EnzymeDB/EnzymeDB_ImageAnswer008.3"
            },
            correctIndex = 2,
            questionNumber = 8,
            answerType = AnswerType.Image,
            ...
            prerequisites = null,
            questionHint = new QuestionHint { text = "Use a analogia do próprio nome do modelo. Ele foi proposto para explicar especificidade por meio de formas que combinam entre si. Pense em uma interação mais rígida e pré-ajustada, diferente de modelos que enfatizam mudanças conformacionais posteriores. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A atividade de uma enzima depende de mais do que sua sequência linear. Pense em como o dobramento da proteína organiza grupos químicos no espaço e cria uma região funcional capaz de reconhecer moléculas e catalisar reações. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Para classificar uma enzima, olhe primeiro para o tipo de transformação química descrita. A pergunta envolve mover um grupo químico de uma molécula para outra. Associe esse padrão à classe enzimática definida pelo tipo de reação catalisada. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            questionImagePath = "QuestionImages/EnzymeDB/imageQuestion_enzymes_012",
//            questionLevel = 2,
//            questionInDevelopment = false,
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Na imagem, observe onde a pequena molécula aparece encaixada na superfície da proteína. A pergunta pede identificar o significado funcional dessa região. Procure a alternativa que descreve uma área de contato diretamente relacionada à ligação e à reação. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense em fatores que podem modificar a forma da enzima, a frequência de encontro com o substrato ou a ocupação de regiões funcionais. A pergunta pede uma visão integrada da atividade enzimática, não apenas um único fator físico isolado. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Interprete o ensaio comparando as velocidades medidas em diferentes valores de pH. A condição com maior atividade indica onde grupos químicos da enzima e do substrato ficam mais adequados para interação e catálise naquele sistema experimental. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Separe dois efeitos da temperatura: aumentos moderados podem favorecer colisões moleculares, mas calor excessivo pode prejudicar a estrutura proteica. A queda abrupta em temperatura muito alta sugere analisar a estabilidade conformacional da enzima. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense no que acontece quando o aquecimento ultrapassa o intervalo tolerado por uma proteína. A pergunta não trata de pequenas variações de temperatura, mas de uma condição capaz de comprometer a forma necessária para a função catalítica. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Associe função enzimática à organização tridimensional da proteína. Quando essa organização é perturbada, a região funcional pode deixar de reconhecer o substrato corretamente. A pergunta pede o significado geral desse processo, não um exemplo específico. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Considere agentes que desestabilizam interações responsáveis pelo dobramento proteico. Temperatura elevada, mudanças intensas de acidez e certos solventes podem afetar a conformação. Avalie se as opções representam mecanismos semelhantes de perda estrutural. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Analise o termo pelo efeito sobre a reação catalisada. Essas moléculas interferem na atividade da enzima por ocupação de regiões funcionais ou alteração de conformação. Pense no resultado esperado quando a enzima encontra esse tipo de regulador. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Compare interações transitórias com modificações duradouras na enzima. A pergunta destaca um tipo de inibição em que a recuperação espontânea da atividade não é simples. Foque na estabilidade da ligação ou alteração produzida pelo inibidor. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            answerType = AnswerType.Text,
//            questionType = QuestionType.Image,
//            questionImagePath = "QuestionImages/EnzymeDB/imageQuestion_enzymes_021",
//            questionLevel = 2,
//            questionInDevelopment = false,
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Na imagem, repare que o substrato ainda aparece no encaixe principal, enquanto outra molécula se liga em uma região separada. Use essa relação espacial para inferir o tipo de inibição, sem depender apenas do rótulo “inibidor”. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            answerType = AnswerType.Text,
//            questionType = QuestionType.Image,
//            questionImagePath = "QuestionImages/EnzymeDB/imageQuestion_enzymes_022",
//            questionLevel = 2,
//            questionInDevelopment = false,
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Na imagem, observe que a molécula indicada ocupa a cavidade onde outra molécula normalmente deveria se encaixar. A pista principal está na disputa pelo mesmo espaço físico da enzima, e não em uma alteração distante da estrutura. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Em gráficos de cinética, alguns parâmetros descrevem velocidade máxima e outros descrevem a concentração de substrato associada a pontos específicos da curva. Para interpretar Km, procure a ideia ligada à meia velocidade máxima, não ao produto final. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A equação apresentada combina parâmetros cinéticos com a concentração disponível de substrato. Antes de calcular velocidade, identifique quais grandezas aparecem diretamente na fórmula. A resposta deve reunir os termos necessários, sem incluir variáveis externas ao modelo. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Na equação de Michaelis-Menten, diferencie o parâmetro associado ao limite superior da curva daquele ligado à concentração de substrato. Pense no que acontece quando praticamente todos os sítios catalíticos estão ocupados durante o ensaio. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            answerType = AnswerType.Text,
//            questionType = QuestionType.Image,
//            questionImagePath = "QuestionImages/EnzymeDB/imageQuestion_enzymes_028",
//            questionLevel = 1,
//            questionInDevelopment = false,
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Observe os eixos do gráfico: ambos usam grandezas invertidas, e a reta permite estimar parâmetros cinéticos pelos interceptos. A pista está no formato linear derivado da cinética de Michaelis-Menten, não em uma curva hiperbólica comum. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Associe cada enzima ao tipo de biomolécula e ligação que ela reconhece. A amostra contém ácido nucleico específico, enquanto a restrição evita agir sobre proteínas. Procure a alternativa cujo campo de ação corresponde ao substrato descrito. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense na composição das proteínas: aminoácidos unidos por ligações peptídicas. A pergunta pede o tipo de enzima capaz de quebrar essas ligações durante digestão ou processamento molecular, distinguindo esse substrato de lipídios, carboidratos e ácidos nucleicos. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Concentre-se no tipo de mancha descrita e no substrato químico predominante. Gorduras envolvem lipídios e ligações características de triglicerídeos. A enzima adequada deve atuar sobre esse grupo de moléculas, não sobre proteínas, amido ou RNA. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pão e batata são ricos em polímeros de glicose. A pergunta pede a enzima que inicia a quebra desse carboidrato em fragmentos menores durante a digestão. Relacione o substrato alimentar ao tipo de ligação química presente no polímero. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Use duas pistas juntas: o alimento contém proteínas e o ambiente descrito é fortemente ácido. Entre enzimas digestivas, algumas atuam melhor no estômago e outras em regiões mais neutras ou alcalinas. Relacione compartimento, pH e substrato. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Compare enzimas que atuam sobre substratos semelhantes, mas em ambientes diferentes. A pergunta destaca adaptação ao estômago, então avalie como pH ácido pode preservar ou prejudicar a conformação e os grupos químicos da região catalítica. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A descrição combina localização intestinal, origem pancreática e preferência por certos aminoácidos. Em vez de pensar apenas em “enzima digestiva”, relacione a especificidade da protease ao tipo de resíduo próximo da ligação peptídica a ser rompida. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Observe em qual faixa de pH ocorre o pico de atividade e relacione essa condição ao ambiente do sistema digestório em que a quimotripsina atua normalmente. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A pergunta situa o processo na boca e menciona alimento rico em amido. Pense em qual enzima está presente na saliva e inicia a digestão de carboidratos antes que o alimento chegue ao ambiente ácido do estômago. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            answerType = AnswerType.Text,
//            questionType = QuestionType.Image,
//            questionImagePath = "QuestionImages/EnzymeDB/imageQuestion_enzymes_038",
//            questionLevel = 2,
//            questionInDevelopment = false,
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Compare o pH da boca com o do estômago. Uma enzima ativa em ambiente quase neutro pode perder desempenho quando grupos químicos mudam de ionização ou a estrutura se desestabiliza em acidez intensa. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A palavra-chave é irreversível. Pense em uma alteração que não desaparece facilmente quando o inibidor é removido. A consequência sobre a atividade deve ser avaliada pela dificuldade de recuperar a enzima funcional. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Nesse tipo de inibição, duas moléculas disputam uma mesma região funcional. Pergunte-se qual mudança experimental aumentaria a chance de o substrato ocupar esse espaço em vez do inibidor, sem modificar diretamente a enzima. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Diferencie uma disputa pelo encaixe principal de uma ligação em outro local da enzima. Se o problema não está apenas na ocupação do sítio do substrato, aumentar substrato pode não restaurar plenamente a catálise. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Relacione os fármacos ao sistema renina-angiotensina-aldosterona e localize a etapa que transforma um precursor circulante em um peptídeo com forte ação vascular. Compare a nomenclatura das enzimas propostas com a reação bloqueada e com o efeito esperado sobre a pressão arterial." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Avalie a frase procurando exceções importantes. Em bioquímica, muitas regras introdutórias são verdadeiras para a maioria dos casos, mas podem falhar quando moléculas de RNA com atividade catalítica entram na discussão. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense no desafio de manter vias metabólicas rápidas sem aquecer a célula ou alterar drasticamente o meio. A função da enzima deve ser relacionada ao caminho energético da reação e ao tempo necessário para atingir produtos. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A mutação está localizada justamente em aminoácidos que formam a cavidade funcional. Pergunte-se como mudanças de forma, carga ou polaridade nessa região afetariam reconhecimento molecular, ligação ao substrato e transformação química durante a catálise. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Procure o mecanismo comum por trás de pH e temperatura. Ambos podem alterar propriedades essenciais da proteína, seja mudando cargas de grupos químicos, seja desestabilizando interações que mantêm a forma funcional. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A pergunta descreve perda de forma tridimensional após calor intenso. Relacione esse evento à estabilidade de proteínas e ao efeito sobre regiões funcionais. O termo procurado nomeia o processo estrutural, não uma reação metabólica. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Antes de uma reação ocorrer, os reagentes precisam alcançar uma condição energética favorável. A pergunta pede o nome dessa exigência inicial. Pense na barreira que uma enzima ajuda a contornar, não na energia liberada depois. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A pergunta pede condições de maior eficiência, não limites extremos. Pense em valores nos quais a estrutura da enzima permanece estável e os grupos químicos do sítio funcional estão adequados para a interação com o substrato. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Relacione a região perguntada ao primeiro contato funcional entre enzima e substrato. Essa parte da proteína é organizada pelo dobramento tridimensional e reúne características de forma e química adequadas ao reconhecimento molecular. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            conceptTags = new List<string> { "lock_and_key_model", "specificity" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Use a analogia do modelo para pensar em especificidade. A pergunta não trata de armazenamento de energia nem síntese de outras biomoléculas, mas de como uma enzima distingue moléculas compatíveis com sua região funcional. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Separe fatores que afetam interações moleculares de características apenas visuais. Atividade enzimática depende de condições que mudam estrutura, carga, disponibilidade de substrato ou presença de reguladores, não de qualquer propriedade observável da solução. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense em moléculas auxiliares que não são a cadeia proteica principal da enzima. Muitas participam carregando elétrons ou grupos químicos e podem derivar de vitaminas. Diferencie essa função de hormônios, polímeros ou substratos estruturais. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            conceptTags = new List<string> { "enzyme_catalysis", "reaction_rate" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A pergunta busca o mecanismo geral da catálise. Compare uma reação sem enzima com uma reação catalisada e foque na dificuldade energética para atingir o estado intermediário, sem confundir velocidade com mudança no equilíbrio final. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Identifique primeiro o substrato e os produtos desejados. Amido é um carboidrato polimérico, e maltose e dextrinas surgem de sua quebra parcial. A enzima escolhida deve corresponder a esse tipo de ligação e biomolécula. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A descoberta histórica mencionada ajudou a resolver uma dúvida sobre a natureza química das enzimas. Pense no que a cristalização permitiu demonstrar sobre a composição molecular dessa enzima específica e sua relação com outras enzimas conhecidas. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            conceptTags = new List<string> { "enzyme_inhibition", "active_site" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Analise onde o inibidor se liga e com quem ele compete. Se sua ação depende de semelhança com o substrato, o efeito principal ocorre na disputa pelo encaixe funcional, não por destruição permanente da enzima. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Considere a função das enzimas em vias metabólicas. Elas tornam transformações químicas viáveis em tempo biológico, sem serem consumidas como reagentes principais. A alternativa deve expressar esse papel geral, não uma função estrutural ou de transporte. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Avalie a conclusão relacionando estrutura e função. Mesmo que a sequência da proteína permaneça, a organização tridimensional pode ser perdida. Pergunte-se se a região funcional continuaria corretamente formada após uma alteração estrutural completa. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            conceptTags = new List<string> { "lock_and_key_model", "specificity" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "O enunciado já descreve uma analogia clássica. Para escolher o nome, lembre qual modelo compara a compatibilidade entre enzima e substrato a objetos com formas correspondentes, em contraste com explicações mais flexíveis. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            conceptTags = new List<string> { "temperature_effects", "ph_effects" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Classifique as opções entre fatores químicos ou físicos que alteram a função e propriedades que apenas descrevem aparência. Uma enzima responde a condições que afetam estrutura, cargas ou concentração de substrato. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense em componentes auxiliares necessários para algumas enzimas funcionarem plenamente. Eles não fazem parte da cadeia proteica principal e podem ser íons metálicos ou moléculas orgânicas. A pergunta busca o nome geral desse grupo. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Avalie a classificação observando o tipo de reação, não o substrato específico. Quando uma ligação é quebrada com participação de água, a nomenclatura enzimática costuma agrupar esse mecanismo em uma classe própria. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            conceptTags = new List<string> { "protein_structure", "enzyme_activity" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Relacione a atividade enzimática ao dobramento da proteína. A pergunta descreve uma mudança estrutural que prejudica o arranjo da região funcional. Pense no processo, não apenas em uma condição ambiental específica. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            conceptTags = new List<string> { "enzyme_catalysis" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Concentre-se no efeito da enzima sobre o caminho da reação. Ela não muda necessariamente a quantidade final de produto, nem elimina solvente ou substrato. A pista está na barreira que separa reagentes do estado intermediário. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense na capacidade de uma enzima reconhecer determinados substratos entre muitas moléculas celulares. Essa propriedade depende da forma e das características químicas da região funcional, permitindo seletividade nas vias metabólicas. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Para comparar afinidade aparente, use um parâmetro extraído da curva de Michaelis-Menten. Ele relaciona concentração de substrato com uma fração da velocidade máxima. A comparação só faz sentido se as condições experimentais forem semelhantes. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Como o valor máximo é igual, concentre-se na concentração de substrato necessária para atingir parte da atividade. Um parâmetro menor indica que a enzima responde melhor quando o substrato está menos disponível. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "O platô indica que aumentar o substrato deixa de produzir grande aumento de velocidade. Pense no número limitado de regiões catalíticas disponíveis e no que acontece quando elas passam a trabalhar próximas da capacidade máxima. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Quando a afinidade aparente parece semelhante, mas o limite máximo de velocidade cai, procure uma explicação que envolva menor eficiência catalítica. A ligação do substrato pode ocorrer, mas o processamento fica comprometido. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A recuperação parcial após retorno ao pH adequado sugere que nem toda alteração foi permanente. Pense em mudanças reversíveis de carga e interação molecular, distinguindo-as de perda estrutural completa da proteína. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Em proteínas, regiões distantes podem se comunicar por mudanças conformacionais. Uma alteração fora da cavidade principal ainda pode modificar a forma ou dinâmica da região funcional, especialmente em sistemas regulados alostericamente. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Pense na utilidade de produzir certas enzimas em forma inativa. Em processos digestivos, ativar a molécula apenas no compartimento correto pode proteger células produtoras e tecidos antes do momento adequado de ação. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Considere que algumas moléculas auxiliares participam da reação carregando elétrons ou grupos químicos entre etapas. A pergunta pede interpretar essa função dentro da catálise, não confundir a molécula auxiliar com a proteína enzimática. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Una as duas observações: reconhecimento seletivo e perda de atividade após calor. Ambas dependem da manutenção da forma tridimensional. Se o aquecimento altera essa forma, a interação específica com o substrato também pode ser afetada. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Avalie a frase como uma generalização. Um parâmetro pode sugerir afinidade aparente, mas desempenho enzimático também depende de velocidade máxima, concentração de substrato, regulação, localização da enzima e contexto celular ou experimental. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Diferencie velocidade de reação e posição de equilíbrio. Catalisadores ajudam o sistema a chegar mais rápido ao estado final permitido pela termodinâmica, mas não devem ser interpretados como força que cria rendimento extra por si só. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Antes de aceitar o protocolo, considere a estabilidade de proteínas sob aquecimento intenso. Se a função depende do dobramento correto, uma etapa de fervura precisa ser justificada por uma propriedade especial da enzima usada. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//        {
//            questionDatabankName = "EnzymeQuestionDatabase",
//            questionText = "O aumento da concentração de substrato restaura a atividade de uma enzima na presença de um inibidor. Com base nesse resultado, um estudante conclui que a enzima estava sob inibição não competitiva. Como essa conclusão deve ser avaliada?",
//            answers = new string[] {
//                "Está correta, pois a inibição não competitiva é revertida pelo aumento da concentração de substrato.",
//                "Está correta, pois todos os inibidores não competitivos se ligam ao sítio ativo.",
//                "Está incorreta, pois o aumento da concentração de substrato não interfere na inibição enzimática.",
//                "Está incorreta, pois a restauração da atividade por excesso de substrato é mais compatível com inibição competitiva."
//            },
//            correctIndex = 3,
//            questionNumber = 82,
//            answerType = AnswerType.Text,
...
//                text = "Avalie se a conclusão do estudante é compatível com o resultado experimental. Quando o aumento da concentração de substrato restaura a atividade, considere a possibilidade de substrato e inibidor disputarem o mesmo sítio de ligação. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar."
//            }
//        },
//        // Question 083
//        new Question
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Avalie o gabarito usando especificidade enzimática. Primeiro identifique qual biomolécula deve ser degradada; depois associe esse substrato ao tipo de ligação química que a enzima reconhece. Um bom gabarito precisa respeitar essa relação. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "A justificativa menciona apenas sequência, mas função proteica também depende de dobramento. Pergunte-se se uma enzima pode manter sua região funcional organizada quando a conformação tridimensional foi perdida ou profundamente alterada. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Não assuma que todas as enzimas digestivas compartilham o mesmo ambiente. Compare boca, estômago e intestino, lembrando que cada compartimento tem pH próprio e seleciona enzimas adaptadas a suas condições. Organize as informações do enunciado antes de avaliar qual alternativa é compatível com esse princípio." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Avalie o modelo como ferramenta didática, não como descrição completa. A analogia rígida ajuda a introduzir especificidade, mas muitas interações reais envolvem mudanças conformacionais durante a aproximação entre enzima e substrato. Use essa relação como critério, verificando separadamente as consequências propostas em cada alternativa." }
//        },
...
//            conceptTags = new List<string> { "industry", "specificity", "mild_conditions" },
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Para julgar a decisão industrial, conecte propriedades de enzimas com objetivos do processo. Condições brandas, seletividade e menor formação de subprodutos podem ser vantagens, mas a escolha também depende de estabilidade e custo operacional. Antes de escolher, identifique a variável que muda e mantenha constantes as demais condições apresentadas." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Observe separadamente a posição marcada para Km e o patamar alcançado por cada curva. Duas curvas podem compartilhar uma mesma referência de substrato sem atingir o mesmo limite de velocidade quando a concentração de substrato aumenta. Analise primeiro estrutura, interação e consequência, evitando decidir apenas pela presença de um termo familiar." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Uma queda de atividade não revela sozinha se o efeito é permanente. Pense em testes de reversibilidade, como remover, diluir ou competir com o inibidor, antes de concluir que houve modificação definitiva da enzima. Confronte as opções com esse modelo conceitual e descarte explicações que misturem processos diferentes." }
//        },
...
//            prerequisites = null,
//            questionHint = new QuestionHint { text = "Revise a definição de componentes auxiliares da catálise. Eles não substituem a enzima como proteína completa; ajudam certas reações por meio de íons ou moléculas orgânicas associadas à estrutura enzimática. Compare cada alternativa com essa relação e elimine as que contradizem o mecanismo descrito." }
//        }
    };
