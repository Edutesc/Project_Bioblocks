...
public class CarbohydratesQuestionDatabase : MonoBehaviour, IQuestionDatabase
{
    ...
    private List<Question> questions = new List<Question>
    {
        ...
        new Question {
            ...
            questionText = "",
            answers = new string[] {
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer5_1",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer5_2",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer5_3",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer5_4"
            },
            correctIndex = 0,
            questionNumber = 5,
            isImageAnswer = true,
        ...
        new Question {
            ...
            questionText = "",
            answers = new string[] {
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer7_1",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer7_2",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer7_3",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer7_4"
            },
            correctIndex = 3,
            questionNumber = 7,
            isImageAnswer = true,
        ...
        new Question {
            ...
            questionText = "",
            answers = new string[] {
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer9_1",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer9_2",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer9_3",
                "AnswerImages/CarbohydrateDB/carbohydrateDB_ImageAnswer9_4"
            },
            correctIndex = 3,
            questionNumber = 9,
            isImageAnswer = true,
